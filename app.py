...
if page == "Dashboard":
    ...
    st.markdown(f"""
**Made by:** {APP_AUTHOR}  
**Description:** Multi-model heart disease predictor with simultaneous predictions, SHAP interpretability (optional), and PDF report export.  
**Model files expected:** DecisionTreeR.pkl, LogisticR.pkl, randomforestR.pkl, svmR.pkl (place them in same folder as app.py)
""")
    st.markdown("</div>", unsafe_allow_html=True)
